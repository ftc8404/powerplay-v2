 ...
 */
public class BNO055IMU extends HardwareDevice {
    ...
    private final com.qualcomm.hardware.bosch.BNO055IMU.Parameters imuParams;
     ...
     */
    public BNO055IMU(String deviceName, String calibrationDataFile, AxesOrder axesOrder, int headingAngleIndex, int pitchAngleIndex, int rollAngleIndex, HardwareMap hwMap) {
        super(deviceName);
        imu = hwMap.get(com.qualcomm.hardware.bosch.BNO055IMU.class, deviceName);
        imuParams = new com.qualcomm.hardware.bosch.BNO055IMU.Parameters();
