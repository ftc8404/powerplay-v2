...
@TeleOp(name = "Drive Motor Test", group = "Main")
...
//        telemetry.addData("ultraSonic1 distance", robot.hardwareCollection.ultraSonic1.getRange());
    ...
    public void loop() {
        if (gamepad1.y){
            robot.hardwareCollection.driveMotorFL.setPower(1);
        } else {
            robot.hardwareCollection.driveMotorFL.setPower(0);
        }
        if (gamepad1.b){
            robot.hardwareCollection.driveMotorFR.setPower(1);
        } else {
            robot.hardwareCollection.driveMotorFR.setPower(0);
        }
        if (gamepad1.x){
            robot.hardwareCollection.driveMotorBL.setPower(1);
        } else {
            robot.hardwareCollection.driveMotorBL.setPower(0);
        }
        if (gamepad1.a){
            robot.hardwareCollection.driveMotorBR.setPower(1);
        } else {
            robot.hardwareCollection.driveMotorBR.setPower(0);
        }
